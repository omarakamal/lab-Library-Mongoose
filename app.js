...
const MongoDB_URL = "mongodb://127.0.0.1:27017/library-mongoose";
...
// Book.findOne({ title: { $regex: "Harry Potter" } })
//   .then((res) => console.log(res))
//   .catch((err) => console.log(err));

//  Iteration 7 - Update a Single Book
// Book.findOneAndUpdate({ title: { $regex: "Harry Potter" } },{pages:750})
//   .then((res) => console.log(res))
//   .catch((err) => console.log(err));
