...
Book.findOneAndUpdate(
    { title: "Harry Potter and the Deathly Hallows." }, // Filtro de búsqueda
    { pages: 790 }, // Objeto de actualización
    { new: true } // Opciones: indica que se devuelva el documento actualizado
  )
    .then((updatedBook) => {
