...
/* Book.findById('65f9f601fe9791ae5771b6fb')
.then((res)=>console.log(res))
.catch((err)=>console.log(err))  */
...
/* Book.findByIdAndUpdate( '65f9f601fe9791ae5771b6fb', {pages:750},{new:true})
.then((res)=>console.log(res))
.catch((err)=>console.log(err)) */
...
Book.findByIdAndDelete('65f9f5f4c288b6a609899d58')
.then((res)=>console.log(res))
.catch((err)=>console.log(err))
